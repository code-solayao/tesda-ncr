...
<body>
    <header class="fixed left-0 top-0 transition-colors duration-300 w-full z-20" 
    ...
    <section class="flex flex-1">
        ...
        <!-- Sidebar -->
        <aside class="bg-sky-200 fixed flex flex-col h-full left-0 p-4 shadow-md top-0 w-3/4 z-30 transform transition-transform ease-in-out duration-300" 
            x-show="sidebarOpen" 
